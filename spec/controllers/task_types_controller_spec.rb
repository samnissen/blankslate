...
RSpec.describe TaskTypesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all task_types as @task_types" do
      ...
      expect(assigns(:task_types)).to eq([task_type])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested task_type as @task_type" do
      ...
      expect(assigns(:task_type)).to eq(task_type)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new task_type as @task_type" do
      ...
      expect(assigns(:task_type)).to be_a_new(TaskType)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created task_type as @task_type" do
        post :create, {:task_type => valid_attributes}, valid_session
        expect(assigns(:task_type)).to be_a(TaskType)
        expect(assigns(:task_type)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved task_type as @task_type" do
        post :create, {:task_type => invalid_attributes}, valid_session
        expect(assigns(:task_type)).to be_a_new(TaskType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested task_type" do
        task_type = TaskType.create! valid_attributes
        put :update, {:id => task_type.to_param, :task_type => new_attributes}, valid_session
        task_type.reload
    ...
    context "with invalid params" do
      it "assigns the task_type as @task_type" do
        task_type = TaskType.create! valid_attributes
        put :update, {:id => task_type.to_param, :task_type => invalid_attributes}, valid_session
        expect(assigns(:task_type)).to eq(task_type)
      end
